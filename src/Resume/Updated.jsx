...
function writtingresume() {
  return (
    <div className="container1-main-1">
      <nav className="breadcrumb-1">
        <a href="/">Blog  </a>
      ...
      <header className="header-1">
        ...
        <button className="create-resume-button-1">Create Your Resume Now</button>
        <div className="author-info-1">
          <img src={profilePic} alt="Author" className="author-pic-1" />
      ...
      <div className='write-resume-1'>
        <div className='write-resume-points-1'>
          ...
          <div className='write-a-resume-1'>
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
          <div class="col">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h5 class="card-title-1">Best Online Resume Builders You Must Try in 2024</h5>
          ...
          <div class="col">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h5 class="card-title-1">General Cover Letter Sample, Generic Template, & Tips</h5>
          ...
          <div class="col">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h5 class="card-title-1">How Long Does It Take to Write a Resume? Zety’s Study</h5>
