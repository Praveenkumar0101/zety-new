...
function writtingresume() {
  return (
    <div className="container1-main">
      ...
      {/* <div className="example-resume">
  <div className="image-container">
    <a href="#">
      <img src='https://cdn-images.zety.com/pages/how_to_make_a_resume_zety_us_bad_example.jpg' alt="Bad Example" />
      <img src='https://cdn-images.zety.com/pages/how_to_make_a_resume_zety_us_good_example.jpg' alt="Good Example" />
    </a>
    <button className="hover-button">use this resume template</button>
  </div>
</div> */}
